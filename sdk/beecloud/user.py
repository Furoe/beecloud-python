...
if __name__ == '__main__':
    from beecloud.entity import BCApp, BCPayReqParams
    from beecloud.utils import order_num_on_datetime
    ...
    # res = add_merchant_user(bc_app, 'merchant_python_user1')
    # print(res.result_code)
    # print(res.result_msg)
    # print(res.err_detail)
    #
    # res = batch_add_merchant_users(bc_app, 'test@beecloud.cn', ['merchant_python_user2', 'merchant_python_user3'])
    # print(res.result_code)
    # print(res.result_msg)
    # print(res.err_detail)
    ...
    # req_params.channel = 'WX_NATIVE'
    # req_params.title = u'python {:s} 支付测试'.format(req_params.channel)
    # req_params.total_fee = 1
    # req_params.bill_no = order_num_on_datetime()
    # req_params.buyer_id = 'merchant_python_user1'
    #
    # res = bc_pay.pay(req_params)
    # if not res.result_code:
    #     print(res.code_url)
    #
    # req_params.channel = 'BC_ALI_QRCODE'
    # req_params.title = u'python {:s} 支付测试'.format(req_params.channel)
    #
    # res = bc_pay.pay(req_params)
    # if not res.result_code:
